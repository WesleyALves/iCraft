...
public class EntityAIAttackCrazy extends EntityAIBase
{
    ...
    public EntityAIAttackCrazy(EntityPizzaDelivery p_i1636_1_, double p_i1636_2_)
    {
        attacker = p_i1636_1_;
    ...
    {
        EntityLivingBase entity = FMLCommonHandler.instance().getMinecraftServerInstance().getConfigurationManager().func_152612_a(attacker.getPlayer());
    ...
    {
        EntityLivingBase entity = FMLCommonHandler.instance().getMinecraftServerInstance().getConfigurationManager().func_152612_a(attacker.getPlayer());
        return (entity == null ? false : (!entity.isEntityAlive() ? false : !attacker.getNavigator().noPath()) && attacker.getAngry());
    }
    ...
    {
        EntityLivingBase target = FMLCommonHandler.instance().getMinecraftServerInstance().getConfigurationManager().func_152612_a(attacker.getPlayer());
